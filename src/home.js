...
const resumeLink =
  "https://drive.google.com/file/d/1kjVQrYlafipLhmWzyLukmeycqPpBqPz0/view?usp=sharing";
const linkedinLink = "https://www.linkedin.com/in/xujustinj/";
...
const DesktopHeading = (props) => {
  ...
  return (
    <Responsive getWidth={getWidth} minWidth={Responsive.onlyTablet.minWidth}>
      ...
      >
        <Segment id="homeHeaderDesktop" inverted textAlign="center" vertical>
          <Menu
  ...
  return (
    ...
    >
      ...
      <Sidebar.Pusher dimmed={sidebar}>
        <Segment id="homeHeaderMobile" inverted textAlign="center" vertical>
          <Container>
      ...
      <Container text>
        <Card.Group centered>
          <Card raised>
            <Image src={asteria} />
            <Card.Content>
              <Card.Header as="a" href="https://github.com/xujustinj/Asteria">
                Asteria
              </Card.Header>
              <Card.Description>
        ...
        <Card.Group centered>
          <Card raised>
            ...
            <Card.Content>
              <Card.Header
                as="a"
                href="https://github.com/xujustinj/swift-record-generator"
              >
          ...
          <Card raised>
            ...
            <Card.Content>
              <Card.Header
                as="a"
                href="https://xujustinj.github.io/Extended-Essay/"
              >
                Ulam Spiral
              </Card.Header>
              <Card.Description>
                When you highlight prime numbers on a spiral number line,
                strange patterns appear. In high school, I wrote a{" "}
                <a href="https://xujustinj.github.io/Extended-Essay/03-01-19%20Version%20(Revision).pdf">
                  paper
                </a>{" "}
                explaining what causes them, and how they might be useful.
              </Card.Description>
            </Card.Content>
            <Card.Content extra>
          ...
          <Card raised>
            ...
            <Card.Content>
              <Card.Header
                as="a"
                href="https://xujustinj.github.io/Hexagonal-2048/"
              >
                Hexagonal 2048
              </Card.Header>
              <Card.Description>
                My introductory project to JavaScript, inspired by my love for
                the original game. Swipe or use QWEASD to control the board.
              </Card.Description>
            </Card.Content>
            <Card.Content extra>
          ...
          <Card raised>
            ...
            <Card.Content>
              <Card.Header
                as="a"
                href="https://docs.google.com/spreadsheets/d/1JsttjsZt6USt7h1Z66PhwibUmafxuH1Mwkzk2tNlDag/edit"
              >
                ADETOS
              </Card.Header>
              <Card.Description>
                A macro-powered spreadsheet that juggles matchmaking,
                scorekeeping, and table management for multiple concurrent
